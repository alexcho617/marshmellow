  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<GameUser>>(
        future: getFutureFirebaseAllUsersData(_currentPlayerUIDS),
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            flex:1,
                            child: Text((index+1).toString(), style: body5style()),
                          ),
                          Expanded(
                            flex:5,
                            child: Text(userList[index].id.toString(), style: body5style()),
                          ),
                          Expanded(
                            flex:1,
                          ...
                          Expanded(
                            flex:1,
                            child: Text(userList[index].localToken.toString(), style: body5style(),textAlign: TextAlign.center,),
                          ),
                        ],
                      ),
                    );
